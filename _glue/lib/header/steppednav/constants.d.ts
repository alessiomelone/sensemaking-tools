//!! generated by tsickle from marketing/glue/lib/header/steppednav/constants.ts
...
declare enum Strings {
    ...
    STEPPEDNAV_LABEL = "$glue_steppednav_label$, Navigate back to parent menu, $glue_steppednav_label$ opened"
}
/**
